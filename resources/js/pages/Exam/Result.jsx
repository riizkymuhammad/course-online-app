...
export default function ResultPage({ question, tryout, result }) {
  const summary = result.summary;

  return (
    <div className="min-h-screen bg-[linear-gradient(to_bottom,_#f8fafc,_#eef6ff)] text-slate-900">
      <Head title={`${question.title} | Hasil Tryout #${tryout.id}`} />
          ...
          <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div>
              ...
              <p className="mt-3 max-w-3xl text-sm leading-7 text-white/80 md:text-base">
                Skor dan ringkasan hasil tes ditampilkan di bawah agar Anda bisa melihat jawaban
                yang benar, salah, dan yang belum dijawab.
              </p>
            </div>
                ...
                <div className="flex flex-wrap items-start justify-between gap-3 border-b border-slate-100 pb-5">
                  <div>
                    ...
                    <h2 className="mt-2 text-xl font-semibold text-slate-900">
                      {item.is_correct ? "Jawaban Benar" : item.is_answered ? "Jawaban Salah" : "Belum Dijawab"}
                    </h2>
                  </div>
                  <div
  ...
  return (
    <div className={`rounded-[24px] border p-4 ${tones[tone]}`}>
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="grid h-11 w-11 place-items-center rounded-2xl bg-white/70">
